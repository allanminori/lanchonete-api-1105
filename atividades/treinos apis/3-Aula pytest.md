...
Unitário: Produto com valor negativo deve lançar ValueError
Unitário: Pedido com qtd_max_produtos=0 deve lançar ValueError
Integração: POST /clientes com CPF vazio deve retornar status 400
Integração: PUT /produtos/{codigo}/valor deve atualizar o valor e retornar {"alterou": true}
End-to-end: Criar um pedido e buscá-lo pelo código via GET /lanchonete/pedidos/{cod_pedido}
